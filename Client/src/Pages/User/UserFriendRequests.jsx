...
import { Check, X, Users, Clock, UserPlus, UserX, Search } from "lucide-react"
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            <Avatar className="h-12 w-12">
                                                ...
                                                />
                                                <AvatarFallback>
                                                    {request.sender?.name?.charAt(0) || request.sender?.email?.charAt(0) || "U"}
                                                </AvatarFallback>
                                            </Avatar>
                                            <div>
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            <Avatar className="h-12 w-12">
                                                ...
                                                />
                                                <AvatarFallback>
                                                    {request.receiver?.name?.charAt(0) || request.receiver?.email?.charAt(0) || "U"}
                                                </AvatarFallback>
                                            </Avatar>
                                            <div>
                                                <p className="font-medium text-gray-900">
                                        ...
                                        <div>
                                            ...
                                            {searchResult.status === 'pending_received' && (
                                                <div className="flex gap-2">
                                                    <Button
                                                        size="sm"
                                                        onClick={() => handleAcceptRequest(searchResult.requestId)}
                                                        disabled={loading.action}
                                                        className="bg-green-600 hover:bg-green-700 text-white"
                                                    >
                                                        <Check className="h-4 w-4 mr-1" />
                                                    ...
                                                    <Button
                                                        size="sm"
                                                        variant="outline"
                                                        onClick={() => handleRejectRequest(searchResult.requestId)}
                                                        disabled={loading.action}
                                                        className="text-red-600 border-red-200 hover:bg-red-50"
                                                    >
                                                        <X className="h-4 w-4 mr-1" />
                                            ...
                                            {(searchResult.status === 'friends' || searchResult.status === 'pending_sent') && (
                                                <Button
                                                    size="sm"
                                                    variant="outline"
                                                    disabled
                                                >
                                                    {searchResult.status === 'friends' ? 'Already Friends' : 'Request Sent'}
                                                </Button>
                                            )}
                                        </div>
                                    </div>
