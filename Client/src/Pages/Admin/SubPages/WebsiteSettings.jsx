...
import { Settings, Save, RefreshCw, Globe, ShoppingBag, Hotel, AlertTriangle } from "lucide-react"
...
import { getWebsiteSettings, updateWebsiteSettings } from "../../../Api/websiteSettings.api"
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Control the visibility and availability of features across your website
                    </p>
                </div>
                <div className="flex items-center space-x-2">
                    <Button
            ...
            <div className="grid gap-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Control which features are visible and accessible to users throughout the website
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Show shop pages, product listings, and shopping cart functionality
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-center space-x-2">
                        ...
                        <div className="flex items-center justify-between p-4 border rounded-lg">
                            <div className="flex items-center space-x-3">
                                ...
                                <div className="space-y-1">
                                    <Label htmlFor="hotels-toggle" className="text-base font-medium">
                                        Hotels & Accommodation
                                    </Label>
                                    <p className="text-sm text-muted-foreground">
                                        Show hotel listings, booking options, and accommodation features
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-center space-x-2">
                                <Badge variant={settings.hotelsEnabled ? "default" : "secondary"}>
