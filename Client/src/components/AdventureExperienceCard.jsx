...
const AdventureExperienceCard = ({ adventureExp, isFullWidth = false, index = 0 }) => {
    const { adventure, experience, completedSessions, lastSessionDate } = adventureExp;
    ...
    return (
        <>
            ...
            <Card
                className={`rounded-2xl border-gray-200 hover:shadow-lg transition-all duration-300 hover:scale-[1.02] ${isFullWidth ? 'max-w-2xl mx-auto' : ''
                    }`}
                style={{
            ...
            >
                <CardHeader className="pb-4">
                    <div className={`flex items-start ${isFullWidth ? 'gap-6' : 'justify-between'}`}>
                        ...
                        {adventure.thumbnail && (
                            <div className={`flex-shrink-0 ${isFullWidth ? 'ml-0' : 'ml-4'}`}>
                                <img
                                    ...
                                    alt={adventure.name}
                                    className={`rounded-lg object-cover shadow-sm ${isFullWidth ? 'w-24 h-24' : 'w-16 h-16'
                                        }`}
                                />
                            </div>
                        )}
                ...
                <CardContent className="pt-0">
                    <div className="space-y-4">
                        ...
                        {/* Stats */}
                        <div className={`grid gap-3 ${isFullWidth ? 'grid-cols-3' : 'grid-cols-2'}`}>
                            ...
                            {isFullWidth && (
                                <>
                                    ...
                                    <div className="flex items-center gap-3 p-3 bg-orange-50 rounded-xl">
                                        ...
                                        <div className="min-w-0">
                                            <p className="text-sm font-semibold text-gray-900">{nextLevelExp - experience}</p>
